...
namespace Backend.Migrations
{
    ...
    [Migration("20241011045002_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.HistorySearch", b =>
                {
                    ...
                    b.HasIndex(new[] { "OtherUser" }, "other_user");
            ...
            modelBuilder.Entity("Backend.Models.Media", b =>
                {
                    ...
                    b.HasIndex(new[] { "PostId" }, "fk_media_post_id");
            ...
            modelBuilder.Entity("Backend.Models.PostNotificationToUser", b =>
                {
                    ...
                    b.HasKey("ToUserId", "PostNotificationId")
                        .HasName("PRIMARY")
                        .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

                    b.HasIndex(new[] { "PostNotificationId" }, "fk_post_notification_to_user_post_notification_id");

                    b.ToTable("post_notification_to_user", (string)null);
                });
            ...
            modelBuilder.Entity("Backend.Models.React", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ReactId"));
            ...
            modelBuilder.Entity("Backend.Models.ReactsPost", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ReactPostId"));
            ...
            modelBuilder.Entity("Backend.Models.User", b =>
                {
                    ...
                    b.HasIndex(new[] { "CoverPhoto" }, "fk_cover");

                    b.HasIndex(new[] { "ProfilePicture" }, "fk_profile");
            ...
            modelBuilder.Entity("ReactsComment", b =>
                {
                    b.Property<int>("ReactId")
                        .HasColumnType("int(11)")
                        .HasColumnName("react_id");
            ...
            modelBuilder.Entity("ReactsUser", b =>
                {
                    b.Property<int>("ReactId")
                        .HasColumnType("int(11)")
                        .HasColumnName("react_id");
                    ...
                    b.HasKey("ReactId", "UserId")
                        .HasName("PRIMARY")
                        .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

                    b.HasIndex(new[] { "UserId" }, "fk_reacts_user_user_id");

                    b.ToTable("reacts_user", (string)null);
                });
            ...
            modelBuilder.Entity("UserMedia", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int(11)")
                        .HasColumnName("user_id");
            ...
            modelBuilder.Entity("Backend.Models.HistorySearch", b =>
                {
                    ...
                    b.HasOne("Backend.Models.User", "OtherUserNavigation")
            ...
            modelBuilder.Entity("Backend.Models.PostNotificationToUser", b =>
                {
                    b.HasOne("Backend.Models.PostNotification", "PostNotification")
                        .WithMany("PostNotificationToUsers")
                        .HasForeignKey("PostNotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Backend.Models.User", b =>
                {
                    b.HasOne("Backend.Models.Media", "CoverPhotoNavigation")
                        .WithMany("UserCoverPhotoNavigations")
                        .HasForeignKey("CoverPhoto")
                        .HasConstraintName("fk_cover");

                    b.HasOne("Backend.Models.Media", "ProfilePictureNavigation")
                        .WithMany("UserProfilePictureNavigations")
                        .HasForeignKey("ProfilePicture")
                        .HasConstraintName("fk_profile");

                    b.Navigation("CoverPhotoNavigation");

                    b.Navigation("ProfilePictureNavigation");
                });
            ...
            modelBuilder.Entity("ReactsComment", b =>
                {
                    ...
                    b.HasOne("Backend.Models.React", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Models.Media", b =>
                {
                    b.Navigation("UserCoverPhotoNavigations");

                    b.Navigation("UserProfilePictureNavigations");
                });
            ...
            modelBuilder.Entity("Backend.Models.PostNotification", b =>
                {
                    b.Navigation("PostNotificationToUsers");
                });
